...
namespace MiniERP.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260723031500_AgregarDevolucionCompra")]
    partial class AgregarDevolucionCompra
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniERP.Domain.Compras.Compra", b =>
                {
                    ...
                    b.Property<string>("NcfProveedor")
                        .HasMaxLength(19)
            ...
            modelBuilder.Entity("MiniERP.Domain.Compras.DevolucionCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompraId", "Estado");

                    b.HasIndex("Estado", "Fecha");

                    b.HasIndex("ProveedorId", "Fecha");

                    b.ToTable("DevolucionesCompra", (string)null);
                });

            modelBuilder.Entity("MiniERP.Domain.Compras.LineaCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MiniERP.Domain.Compras.LineaDevolucionCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LineasDevolucionCompra", (string)null);
                });
            ...
            modelBuilder.Entity("MiniERP.Domain.Finanzas.CategoriaEgreso", b =>
                {
                    ...
                    b.ToTable("CategoriasEgreso", (string)null);
                });
            ...
            modelBuilder.Entity("MiniERP.Domain.Finanzas.Egreso", b =>
                {
                    ...
                    b.HasIndex("CategoriaEgresoId", "Fecha");
            ...
            modelBuilder.Entity("MiniERP.Domain.Ventas.Factura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MiniERP.Domain.Ventas.LineaFactura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MiniERP.Domain.Ventas.SecuenciaNcf", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TipoComprobante", "Activa");

                    b.ToTable("SecuenciasNcf", (string)null);
                });
            ...
            modelBuilder.Entity("MiniERP.Domain.Compras.DevolucionCompra", b =>
                {
                    b.HasOne("MiniERP.Domain.Compras.Compra", "Compra")
                        .WithMany()
            ...
            modelBuilder.Entity("MiniERP.Domain.Compras.LineaDevolucionCompra", b =>
                {
                    b.HasOne("MiniERP.Domain.Compras.DevolucionCompra", "Devolucion")
                        .WithMany("Lineas")
                        .HasForeignKey("DevolucionCompraId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MiniERP.Domain.Compras.LineaCompra", "LineaCompra")
                        .WithMany()
            ...
            modelBuilder.Entity("MiniERP.Domain.Finanzas.Egreso", b =>
                {
                    b.HasOne("MiniERP.Domain.Finanzas.CategoriaEgreso", "CategoriaEgreso")
                        .WithMany("Egresos")
            ...
            modelBuilder.Entity("MiniERP.Domain.Ventas.LineaFactura", b =>
                {
                    b.HasOne("MiniERP.Domain.Ventas.Factura", "Factura")
                        .WithMany("Lineas")
